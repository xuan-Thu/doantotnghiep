...
<div class="card shadow mb-4">
  ...
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary float-left">Shipping unit List</h6>
  ...
  <div class="card-body">
    <div class="table-responsive">
      ...
      @else
        <h6 class="text-center">No shippings unit found!!! Please create shipping unit</h6>
      @endif
    </div>
  </div>
</div>
